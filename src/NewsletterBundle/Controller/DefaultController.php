...
use NewsletterBundle\Entity\Campaign;
...
class DefaultController extends Controller
{
    ...
    public function viewAction($id)
    {
        ...
        ->getManager()
        ->getRepository('NewsletterBundle:Campaign')
        ;
        ...
        if (null === $campaign) {
              throw new NotFoundHttpException("La campagne d'id ".$id." n'existe pas.");
        }
    ...
    public function addAction(Request $request)
    {
        ...
        $newsletter->setName('2017/0304');
        $newsletter->setRpCampaign('WDA20170304ACTIF');
        $newsletter->setCampaign('EXTRA7');

        // Création de l'entité Campaign
        $campaign = new Campaign();
        $campaign->setTitle('Campagne de test');
        $campaign->setPromotion('EXTRA7');

    	  // On lie la newsletter à la campaign
        $newsletter->setCampaign($campaign);
